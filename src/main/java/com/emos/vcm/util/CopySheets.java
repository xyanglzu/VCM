...
public class CopySheets {
     ...
     * @param styleMap  -
     */
    public static void copyRow(HSSFSheet srcSheet, HSSFSheet destSheet, HSSFRow srcRow, HSSFRow destRow, Map<Integer, CellStyle> styleMap) {
     ...
     * @param styleMap
     */
    public static void copyCell(HSSFCell oldCell, HSSFCell newCell, Map<Integer, CellStyle> styleMap) {
        if (styleMap != null) {
    ...
    public HSSFWorkbook mergeExcelFiles(HSSFWorkbook book, List<InputStream> inList) throws Exception {
